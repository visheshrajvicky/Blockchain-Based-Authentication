...
<body>
<h1>If you are a new user than please upload your certificate's key and value on bloackchain.</h1>
...
<form>
    ...
    <button type="button" onclick="Uploadinfo();">Upload</button>
</form>
...
Status: <span id="status">Loading...</span>
	...
	},
	{
        ...
        async function Uploadinfo() {
			...
			const account = await getCurrentAccount();0
			console.log(key, document.getElementById("value").value);
            await window.contract.methods.UploadCertInfo(key, value).send({ from: account });
